...
Ex No6:SCHEMATIC ENTRY AND SIMULATION OF CMOS INVERTER, CMOS NAND and CMOS NOR USING CADENCE TOOL
...
The design and simulation of  CMOS inverter is observed,  the DC and transient responses using cadence tool
